...
class RevSliderAdmin extends RevSliderBaseAdmin{
	...
	private function init(){
		...
		self::addMenuPage('MCreateX Revolution', "adminPages");
	...
	public static function show_purchase_notice(){
        ...
        <tr class="plugin-update-tr"><td colspan="<?php echo $wp_list_table->get_column_count(); ?>" class="plugin-update colspanchange">
            ...
            <?php _e('Activate MCreateX Revolution for <a href="http://mcreatex.com" target="_blank">Premium Benefits (e.g. Live Updates)</a>.', 'revslider'); ?>
            </div>
        </tr>
        <?php 
	}
	...
	public static function show_update_notice(){
        ...
        <tr class="plugin-update-tr"><td colspan="<?php echo $wp_list_table->get_column_count(); ?>" class="plugin-update colspanchange">
            ...
            <?php _e('A new version of MCreateX Revolution is available.', 'revslider'); ?>
            </div>
        </tr>
        <?php 
	}
	...
	protected static function get_javascript_multilanguage(){
		$lang = array(
			...
			'this_feature_only_if_activated' => __('This feature is only available if you activate MCreateX Revolution for this installation', 'revslider'),
			...
			'of_slider_revolution' => __('of MCreateX Revolution to work.', 'revslider'),
			'slider_revolution_shortcode_creator' => __('MCreateX Revolution Shortcode Creator', 'revslider'),
	...
	public function add_notices(){
		...
		if($enable_newschannel == 'on'){
			...
			if($vn == true){
				...
				$notices[99999]->text = '<p>'.__('Hi, your Purchase Code for MCreateX Revolution has been deregistered manually through <a href="http://www.themepunch.com/purchase-code-deactivation" target="_blank">http://www.themepunch.com/purchase-code-deactivation</a> and is no longer active for this installation.', 'revslider').'</p>';
			...
			if($tmp == 'true'){
				...
				$notices[99998]->text = '<p>'.__('Hi, your Purchase Code for MCreateX Revolution has been deregistered as it was not a valid MCreateX Revolution Purchase Code', 'revslider').'</p>';
