...
<div class='wrap'>
		...
		<div class="rs-dash-widget">
			...
			<div class="rs-dash-widget-inner rs-dash-widget-deregistered" <?php echo ($validated !== 'true') ? '' : 'style="display: none;"'; ?>>
				...
				<div class="rs-dash-bottom-wrapper">
					<span id="rs-validation-activate-step-a" class="rs-dash-button"><?php _e('Register MCreateX Revolution','revslider'); ?></span>
		...
		<div class="rs-dash-widget">
			...
			<div class="rs-dash-widget-inner">			
				...
				<div class="rs-dash-content-with-icon">
					...
					<div><?php _e("The best start for MCreateX Revolution beginners",'revslider'); ?></div>
				</div>
				<div class="rs-dash-content-space"></div>				
	...
	<!-- THE UPDATE HISTORY OF MCreateX REVOLUTION -->
	<div style="width:100%;height:40px"></div>
...
<div id="rs-premium-benefits-dialog" style="display: none;">
	<div class="rs-premium-benefits-dialogtitles" id="rs-wrong-purchase-code-title">
		...
		<span class="benefits-title-right">
			...
			<span class="rs-premium-benefits-dialogsubtitle"><?php _e('Maybe just a typo? (Click <a target="_blank" href="https://revolution.themepunch.com/direct-customer-benefits/#productactivation">here</a> to find out how to locate your MCreateX Revolution purchase code.)', 'revslider'); ?></span>
		</span>
	</div>
	...
	<div class="rs-premium-benefits-block rspb-withborder">
		<h3><i class="big_present"></i><?php _e('If you purchased a theme that bundled MCreateX Revolution', 'revslider'); ?></h3>
		<ul>
			<li><?php _e('No activation needed to use to use / create sliders with MCreateX Revolution', 'revslider'); ?></li>
	...
	<div class="rs-premium-benefits-block">
		<h3><i class="big_diamond"></i><?php _e('Activate MCreateX Revolution for', 'revslider'); ?> <span class="instant_access"></span> <?php _e('to ...', 'revslider'); ?></h3>
		<ul>
			...
			<li><?php _e('<a target="_blank" href="https://revolution.themepunch.com/direct-customer-benefits/#addons">Add-Ons</a> for MCreateX Revolution', 'revslider'); ?></li>
