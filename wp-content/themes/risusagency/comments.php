...
<div class="comments">
  <div id="thecomments">
    <ol class="commentlist">
	    <h3><?php $commentscount = get_comments_number();      echo   $commentscount . esc_html__(' Comments ', 'risusagency'); ?></h3>
      <?php wp_list_comments('callback=risusagency_theme_comment'); ?>
      <?php
      ...
      <nav class="navigation comment-navigation" role="navigation">
        <div class="nav-previous">
          <?php previous_comments_link( esc_html__( '&larr; Older Comments', 'risusagency' ) ); ?>
        </div>
        <div class="nav-next">
          <?php next_comments_link( esc_html__( 'Newer Comments &rarr;', 'risusagency' ) ); ?>
        </div>
      </nav>
      <!-- .comment-navigation -->
      ...
      <p class="no-comments">
        <?php esc_html_e( 'Comments are closed.' , 'risusagency' ); ?>
      </p>
      <?php endif; ?>
    </ol>
  </div>
    ...
    <div id="respond" class="comment-respond">
      <?php
            if ( is_singular() ) wp_enqueue_script( "comment-reply" );
                ...
                $comment_args = array(
                        'id_form' => 'commentform',                                
                        'title_reply'=> esc_html__('Leave a reply','risusagency'),
                        'fields' => apply_filters( 'comment_form_default_fields', array(
                         ...
                         'label_submit' => esc_html__( 'Post Comment', 'risusagency' ),
